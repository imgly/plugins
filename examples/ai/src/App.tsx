      ...
      ref={(domElement) => {
        if (domElement != null) {
          ...
          CreativeEditorSDK.create(domElement, {
            ...
            // Change to 'de' to test German translations
            locale: 'de',
            ...
            .then(async (instance) => {
              ...
              let providerPartner = searchParams.get(
                'partner'
              ) as ProviderPartner | null;
              ...
              if (
                currentArchive !== archiveType ||
                currentPartner !== providerPartner
              ) {
                setSearchParams(
                  { archive: archiveType, partner: providerPartner },
                  { replace: true }
                );
              }
                ...
                ({ builder }) => {
                  builder.Button('testTranslations', {
                    ...
                    onClick: () => {
                      ...
                      // @ts-ignore
                      window.resetTranslations = () =>
                        resetTranslations(instance);
                    }
                  });
                }
              );
                ...
                instance.ui.registerComponent(
                  ...
                  ({ builder }) => {
                    const isFeatureEnabled = (featureId: string) => {
                      try {
                        return instance.feature.isEnabled(featureId, {
...
export function getCropConstraintMetadata(engine: any): CropConstraint {
  const page = engine.scene.getCurrentPage();
