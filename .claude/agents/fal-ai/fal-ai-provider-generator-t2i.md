...
- The model identifier provided to you (e.g., `fal-ai/ideogram/v3`) is the EXACT API endpoint
- **DO NOT** simplify, shorten, or reformat the model key (e.g., DO NOT change `fal-ai/ideogram/v3` to `fal-ai/ideogram/v3.0` or `fal-ai/ideogram-v3`)
...
```typescript
const modelKey = 'fal-ai/flux-general'; // EXACT as provided
```

**Example of WRONG usage:**
```typescript
const modelKey = 'fal-ai/flux/general'; // ❌ WRONG - modified!
```
