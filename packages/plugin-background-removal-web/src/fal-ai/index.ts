...
const FalAi = {
   ...
   * @param config - Provider configuration
   */
  BriaBackgroundRemove: (config: Parameters<typeof createBackgroundRemovalProvider>[1]) => 
   ...
   * @param config - Provider configuration
   */
  RembgEnhance: (config: Parameters<typeof createBackgroundRemovalProvider>[1]) => 
   ...
   * @param config - Provider configuration
   */
  ImageutilsRembg: (config: Parameters<typeof createBackgroundRemovalProvider>[1]) => 
