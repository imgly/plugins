...
import Flux2Image2ImageSchema from './Flux2.image2image.json';
...
export function Flux2Image2Image(
  ...
  return async ({ cesdk }: { cesdk: CreativeEditorSDK }) => {
    ...
    return createImageProvider<Flux2Image2ImageInput>(
      {
        modelSlug: 'flux-2-edit',
        modelVersion: '0.0.1',
        providerId,
        name: 'Flux 2 Edit',
        // @ts-ignore - JSON schema types are compatible at runtime
        schema: Flux2Image2ImageSchema,
        inputReference: '#/components/schemas/Flux2Image2ImageInput',
        cesdk,
        ...
        mapInput: (input) => {
          ...
          // flux-2-edit uses image_urls (array) for image input
          const imageUrls =
