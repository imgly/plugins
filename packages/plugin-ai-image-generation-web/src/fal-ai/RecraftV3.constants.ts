...
// prettier-ignore
export const STYLES_IMAGE: StyleId[] = [
  // 'any',
  'realistic_image',
...
// prettier-ignore
export const STYLES_VECTOR: StyleId[] = [
  'vector_illustration',
...
/**
 * Returns the translation key for a style ID.
 * The actual translation will be resolved by the i18n system.
 */
export function getStyleTranslationKey(styleId: StyleId): string {
  return `ly.img.plugin-ai-generation-web.defaults.property.style.${styleId}`;
}
